...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/components/newNote/new-note.component.html":
  /*!**************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/newNote/new-note.component.html ***!
    \**************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsNewNoteNewNoteComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  "./node_modules/raw-loader/dist/cjs.js!./src/app/components/notesList/notes-list.component.html":
  /*!******************************************************************************************************!*\
    !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/components/notesList/notes-list.component.html ***!
    \******************************************************************************************************/
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsNotesListNotesListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_notesList_notes_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./components/notesList/notes-list.component */
    "./src/app/components/notesList/notes-list.component.ts");
    /* harmony import */


    var _components_newNote_new_note_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./components/newNote/new-note.component */
    "./src/app/components/newNote/new-note.component.ts");

    var routes = [{
      path: '',
      component: _components_notesList_notes_list_component__WEBPACK_IMPORTED_MODULE_3__["notesList"]
    }, {
      path: 'new-note',
      component: _components_newNote_new_note_component__WEBPACK_IMPORTED_MODULE_4__["NewNote"]
    }, {
      path: 'edit-note/:id',
      component: _components_newNote_new_note_component__WEBPACK_IMPORTED_MODULE_4__["NewNote"]
    }, {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _components_notesList_notes_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./components/notesList/notes-list.component */
    "./src/app/components/notesList/notes-list.component.ts");
    /* harmony import */
    ...
    var _materil_modules__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    /*! ./materil-modules */
    "./src/app/materil-modules.ts");
    /* harmony import */
    ...
    var _components_newNote_new_note_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./components/newNote/new-note.component */
    "./src/app/components/newNote/new-note.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _components_notesList_notes_list_component__WEBPACK_IMPORTED_MODULE_6__["notesList"], _components_newNote_new_note_component__WEBPACK_IMPORTED_MODULE_10__["NewNote"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["NoopAnimationsModule"], _materil_modules__WEBPACK_IMPORTED_MODULE_8__["DemoMaterialModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_5__["ReactiveFormsModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_7__["BrowserAnimationsModule"]],
      providers: [],
  ...
  /*! exports provided: NewNote */

  /***/
  function srcAppComponentsNewNoteNewNoteComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NewNote", function () {
      return NewNote;
    });
    /* harmony import */
    ...
    var _services_notes_list_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ../../services/notes-list.service */
    "./src/app/services/notes-list.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function NewNote(fb, notesListService, matSnackBar, activatedRoute) {
        ...
        this.host = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiServer;
        ...
        this.newNoteForm = this.fb.group({
          noteTitle: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
          noteThumb: [null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]],
          noteText: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required]]
        });
      }
      ...
      _createClass(NewNote, [{
        ...
        value: function getNote() {
          ...
          this.notesListService.getNote(this.noteId).subscribe(function (data) {
            console.log(data);
            _this.note = data;
            _this.preview = _environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].apiServer + data.thumb;

            _this.newNoteForm.patchValue({
        ...
        value: function submit() {
          ...
          if (this.note) {
            this.notesListService.updateNote(this.noteId, this.newNoteForm.value.noteTitle, this.newNoteForm.value.noteThumb, this.newNoteForm.value.noteText).subscribe(function (data) {
              _this3.formLoading = false;

              _this3.matSnackBar.open(data.text, 'Ok', {
                duration: 5000
              });
            });
          } else {
            this.notesListService.createNote(this.newNoteForm.value.noteTitle, this.newNoteForm.value.noteThumb, this.newNoteForm.value.noteText).subscribe(function (data) {
              _this3.newNoteForm.reset();

              _this3.selectedFile = null;
              _this3.preview = '';
              Object.keys(_this3.newNoteForm.controls).forEach(function (name) {
                var control = _this3.newNoteForm.controls[name];
                control.setErrors(null);
              });

              _this3.newNoteForm.markAsUntouched();
    ...
    NewNote.ctorParameters = function () {
      return [{
        type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]
      }, {
        type: _services_notes_list_service__WEBPACK_IMPORTED_MODULE_3__["NotesListService"]
      }, {
    ...
    NewNote = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'new-note',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./new-note.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/newNote/new-note.component.html")).default
    })], NewNote);
    /***/
  },
  ...
  /***/
  function srcAppComponentsNotesListNotesListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "notesList", function () {
      return notesList;
    });
    /* harmony import */
    ...
    var _services_notes_list_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../../services/notes-list.service */
    "./src/app/services/notes-list.service.ts");
    /* harmony import */
    ...
    /*#__PURE__*/
    function () {
      function notesList(notesListService, matSnackBar) {
        _classCallCheck(this, notesList);

        this.notesListService = notesListService;
        this.matSnackBar = matSnackBar;
        this.host = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiServer;
      ...
      _createClass(notesList, [{
        ...
        value: function getNotes() {
          ...
          this.notesListService.getNotes().subscribe(function (notes) {
            _this4.notes = notes;
            _this4.filteredNotes = notes;
            _this4.notesLoading = false;
            console.log(_this4.notes);
          });
        }
      }, {
        key: "deleteNote",
        value: function deleteNote(id, index) {
          var _this5 = this;

          var deleteNote = confirm('Видалити нотатку?');

          if (deleteNote) {
            this.notes.splice(index, 1);
            this.notesListService.deleteNote(id).subscribe(function (data) {
              console.log(data);

              _this5.matSnackBar.open(data.text, 'Ok', {
                duration: 2000
              });
            });
          }
        ...
        key: "searchNote",
        value: function searchNote(searchText) {
          if (searchText) {
            searchText = searchText.toLowerCase();
            this.filteredNotes = this.notes.filter(function (el) {
    ...
    notesList.ctorParameters = function () {
      return [{
        type: _services_notes_list_service__WEBPACK_IMPORTED_MODULE_2__["NotesListService"]
      }, {
        type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_4__["MatSnackBar"]
      }];
    };

    notesList = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'notes-list',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./notes-list.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/components/notesList/notes-list.component.html")).default
    })], notesList);
    /***/
  },
  ...
  /***/
  function srcAppMaterilModulesTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppServicesNotesListServiceTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "NotesListService", function () {
    ...
    var NotesListService =
    /*#__PURE__*/
    function () {
      function NotesListService(http) {
        _classCallCheck(this, NotesListService);

        this.http = http;
        this.siteUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiServer;
      }

      _createClass(NotesListService, [{
        key: "getNotes",
        value: function getNotes() {
          return this.http.get(this.siteUrl + '/api/notes');
        }
      }, {
        key: "createNote",
        value: function createNote(noteTitle, noteThumb, noteText) {
        ...
        key: "updateNote",
        value: function updateNote(id, noteTitle, noteThumb, noteText) {
          var formData = new FormData();
    ...
    NotesListService.ctorParameters = function () {
      return [{
        type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"]
      }];
    };

    NotesListService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: 'root'
    })], NotesListService);
    /***/
  },
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\Kursach\server\admin\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
